...
class CheckExistence @Inject constructor(
    private val githubRepositories: GithubRepositories
) {
    suspend operator fun invoke(githubRepository: GithubRepository) : Int = githubRepositories.checkIfExists(githubRepository)
}